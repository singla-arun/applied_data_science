...
cities = pd.read_html(
    "C:\\Users\\singl\\PYTHON\\Univ of Michigan\\Applied Data Science -University of Michigan\\Introduction to Data Science in Python\\Files\\home\\jovyan\\work\\assignments\\course1_assignment4\\assets\\wikipedia_data.html"
)[1]
nfl_df = pd.read_csv(
    "C:\\Users\\singl\\PYTHON\\Univ of Michigan\\Applied Data Science -University of Michigan\\Introduction to Data Science in Python\\Files\\home\\jovyan\\work\\assignments\\course1_assignment4\\assets\\nfl.csv"
)

cities = cities.iloc[:-1, [0, 3, 5, 6, 7, 8]]
nfl_df = nfl_df[nfl_df["year"] == 2018].drop(
...
for group, frame in nfl_df.groupby("area"):
    ...
    out_dict = {"Area": group, "Ratio": ratio}
    out.append(out_dict)
